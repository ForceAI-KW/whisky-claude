...
extension Notification.Name {
    static let WhiskyClaudeHidePanel = Notification.Name("WhiskyClaudeHidePanel")
    static let WhiskyClaudeExpandPanel = Notification.Name("WhiskyClaudeExpandPanel")
    ...
    func selectSession(_ id: UUID) {
        ...
        if let index = sessions.firstIndex(where: { $0.id == id }) {
            ...
            if !isTerminalExpanded {
                ...
                NotificationCenter.default.post(name: .WhiskyClaudeExpandPanel, object: nil)
            }
        }
        persistSessions()
    }

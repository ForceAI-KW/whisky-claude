...
class CheckpointManager {
    ...
    private let refPrefix = "refs/WhiskyClaude-snapshots"
    ...
    func createCheckpoint(projectName: String, projectDirectory: String) throws {
        ...
        let tempIndex = NSTemporaryDirectory() + "WhiskyClaude-index-\(UUID().uuidString)"
        ...
        let commit = try git(["commit-tree", tree, "-m", "WhiskyClaude checkpoint \(timestamp)"], in: projectDirectory)
